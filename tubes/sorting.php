    ...
    <div class="container-urutan">
        <div class="col d-inline-flex">
         <div class="input-group me-3">
             <button class="btn btn dropdown-toggle" style="background-color:#f5d1ad;" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="img/sort-up.png" width="25px" alt=""><i class="bi bi-sort-down-alt"></i>&nbsp;</button>
         ...
         <div class="input-group">
             <button class="btn btn-outline dropdown-toggle" style="background-color:#f5d1ad;" type="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="img/sort-down.png" width="25px" alt=""><i class="bi bi-sort-down"></i>&nbsp;</button>
                <ul class="dropdown-menu" style="background-color:#f5d1ad ;">
