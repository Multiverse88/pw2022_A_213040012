...
if(isset($_POST["ubah"])) {
    ...
    if(ubah($_POST) > 0) {
        echo "<script>alert('databerhasil di ubah'); document.location.href = 'index.php'; </script>";
    }
}
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="index.php" class="btn btn-primary">Kembali ke data mahasiswa</a>
    ...
    <div class="row mt-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="npm" name="npm" required maxlength="9"
             minlength="9" style = "width: 150px" value="<?= $mhs["npm"]?>">
        </div>
